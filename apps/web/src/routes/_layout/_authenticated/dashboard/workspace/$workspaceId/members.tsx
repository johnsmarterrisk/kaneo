          ...
          <div className="flex items-center gap-2">
            ...
            {canInvite ? (
              <a
                ...
                className="inline-flex items-center gap-1 rounded-md border px-2.5 py-1 text-xs font-medium text-muted-foreground no-underline hover:text-card-foreground"
              >
